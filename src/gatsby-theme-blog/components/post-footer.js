...
const Footer = ({ previous, next }) => (
	<div className="mt-16">
		<div className="p-8 bg-green-200 rounded-lg shadow-lg md:p-10">
			<p className="text-xl text-gray-700">If you found this guide useful, please consider signing up to our mailing list, as we produce quality content on a regular basis.</p>
