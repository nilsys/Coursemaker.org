					...
					<div className="flex flex-wrap">
						<div className="w-full bg-gray-200 md:w-1/2">
							<div className="p-10 pb-0 md:p-12 md:pb-0 content">
								...
								<p class="text-gray-600">Some description of this book lorem ipsum dolor sit amet.</p>
							</div>
						...
						<div className="flex flex-wrap items-center w-full md:w-1/2">
							<div className="w-full p-10 content md:p-12">
								<p className="mb-8 text-lg font-bold md:text-xl">Want to know when our awesome online course service launches? Subscribe for updates</p>
